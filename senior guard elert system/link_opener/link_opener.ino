...
const char* ssid = "SANKARAM";             //Add your WiFi ssid
const char* password =  "00000000D";    //Add your WiFi password

String apiKey = "1171163";              //Add your Token number that bot has sent you on WhatsApp messenger
